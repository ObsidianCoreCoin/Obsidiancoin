...
"""Verify that starting obsidian with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start obsidian with -h for help text")
        ...
        self.log.info("Start obsidian with -version for version information")
        ...
        self.log.info("Start obsidiand with -fakearg to make sure it does not start")
