...
- [Development guidelines](#development-guidelines)
    - [General Obsidian Core](#general-obsidian-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Obsidian Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Obsidian Core is a multi-threaded application, and deadlocks or other
...
Obsidian Core can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Obsidian Core, where everyone uses
...
pay attention to for reviewers of Obsidian Core code.

General Obsidian Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Obsidian Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
Some of these are maintained by active developers of Obsidian Core, in which case changes should probably go
directly upstream without being PRed directly against the project.  They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project.  Changes to these should also
be sent upstream but bugfixes may also be prudent to PR against Obsidian Core so that they can be integrated
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Obsidian Core, the wallet was always
