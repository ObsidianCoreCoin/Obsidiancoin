# PSBT Howto for Obsidian Core

Since Obsidian Core 0.17, an RPC interface exists for Partially Signed Obsidian
...
#### Multisig with multiple Obsidian Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
Obsidian Core. We assume their wallets only contain the multisig funds. In case
