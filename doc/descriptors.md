...
- Segwit addresses (bech32, of the form `obs1...` for mainnet or `tobs1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Obsidian's OP_CHECKMULTISIG opcode. To support these, we introduce the
