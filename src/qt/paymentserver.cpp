...
const char* BIP71_MIMETYPE_PAYMENT = "application/obsidian-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/obsidian-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/obsidian-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start obsidian: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("obsidian://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'obsidian://' is not a valid URI. Use 'obsidian:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Obsidian address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
