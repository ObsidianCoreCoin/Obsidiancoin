...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " obsidian-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  obsidian-tx [options] <hex-tx> [commands]  Update hex-encoded obsidian transaction\n" +
            "or:     obsidian-tx [options] -create [commands]   Create hex-encoded obsidian transaction\n" +
            "\n";
