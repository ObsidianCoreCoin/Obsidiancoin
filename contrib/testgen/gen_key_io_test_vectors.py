...
bech32_templates = [
  ...
  ('obs',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('obs',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('obs',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tobs',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tobs',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tobs',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('robs',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('robs',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('robs', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tobs',  17, 32, False, False, False),
  ('robs',  3,  1, False, False, False),
  ('obs',   15, 41, False, False, False),
  ('tobs',  0, 16, False, False, False),
  ('robs',  0, 32, True,  False, False),
  ('obs',   0, 16, True,  False, False),
  ('tobs',  0, 32, False, True,  False),
  ('robs',  0, 20, False, False, True)
]
