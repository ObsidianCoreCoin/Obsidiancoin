...
bech32_templates = [
  ...
  ('obn',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('obn',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('obn',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tobn',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tobn',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tobn',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('robn',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('robn',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('robn', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tobn',  17, 32, False, False, False),
  ('robn',  3,  1, False, False, False),
  ('obn',   15, 41, False, False, False),
  ('tobn',  0, 16, False, False, False),
  ('robn',  0, 32, True,  False, False),
  ('obn',   0, 16, True,  False, False),
  ('tobn',  0, 32, False, True,  False),
  ('robn',  0, 20, False, False, True)
]
